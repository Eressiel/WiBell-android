...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup() {
        ...
        sendSignupData(name, email, password, progressDialog);
...
//                }, 3000);
    ...
    private void sendSignupData(String name, String email, String password, final ProgressDialog progressDialog) {
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("name", name);
        params.put("email", email);
        params.put("password", password);
        CustomJsonRequest request = new CustomJsonRequest
                (Request.Method.POST, BASEPATH + "user/signup", new JSONObject(params), new Response.Listener<JSONObject>() {
